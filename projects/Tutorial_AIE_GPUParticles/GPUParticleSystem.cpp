...
{
	unsigned int vs = Utility::loadShader("./Resources/Shaders/AIEparticles.vert", GL_VERTEX_SHADER);
	unsigned int fs = Utility::loadShader("./Resources/Shaders/AIEparticles.frag", GL_FRAGMENT_SHADER);
	unsigned int gs = Utility::loadShader("./Resources/Shaders/AIEparticles.geom", GL_GEOMETRY_SHADER);
...
void GPUParticleEmitter::createUpdateShader()
{
	...
	unsigned char* source = Utility::fileToBuffer("./Resources/Shaders/AIEparticlesUpdate.vert");
