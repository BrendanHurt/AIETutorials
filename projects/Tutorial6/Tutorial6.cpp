...
void Tutorial6::createOpenGLBuffers(FBXFile* a_fbx)
{
...
void Tutorial6::cleanupOpenGLBuffers(FBXFile* a_fbx)
{
...
bool Tutorial6::onCreate(int a_argc, char* a_argv[]) 
{
	...
	Lighting.LightColor = glm::vec3(0, 1, 0);
	...
	m_vertShader = Utility::loadShader("lit.vert", GL_VERTEX_SHADER);
	m_fragShader = Utility::loadShader("lit.frag", GL_FRAGMENT_SHADER);
